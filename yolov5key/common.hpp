...
void nms(std::vector<Yolo::Detection>& res, float *output, float conf_thresh, float nms_thresh = 0.5) {
    ...
    cout << "output[5]: " << output[5] << endl;
    cout << "output[6]: " << output[6] << endl;
    cout << "output[7]: " << output[7] << endl;
    cout << "output[8]: " << output[8] << endl;
    cout << "output[9]: " << output[9] << endl;
    cout << "output[10]: " << output[10] << endl;
    cout << "output[11]: " << output[11] << endl;
    cout << "output[12]: " << output[12] << endl;
    cout << "output[13]: " << output[13] << endl;
    cout << "output[14]: " << output[14] << endl;
    cout << "output[15]: " << output[15] << endl;
    cout << "output[16]: " << output[16] << endl;
    cout << "output[17]: " << output[17] << endl;
    cout << "output[18]: " << output[18] << endl;
    cout << "output[19]: " << output[19] << endl;
    cout << "output[20]: " << output[20] << endl;
